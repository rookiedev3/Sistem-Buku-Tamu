    ...
    public function checkIn($id)
{
    ...
    public function appointment(Request $request)
    {
        ...
        $guestCategories = guest_categories::select('id', 'name')->get();
        $products = products::where('is_active', 1)->select('id', 'name')->get(); // 🟢 PERBAIKAN: Sertakan 'id'
        $leadSources = lead_sources::select('id', 'name')->get();
    ...
    public function store(Request $request)
{
    ...
    // 3. Normalisasi nomor telepon ke format +62 (inline, tanpa fungsi terpisah)
    $phoneDigits = preg_replace('/\D/', '', $request->phone); // buang semua karakter selain angka
