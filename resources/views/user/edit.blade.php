...
<div class="container my-4">
    <div class="card shadow-sm col-md-8 mx-auto" style="border: 1px solid #e8edf5; border-radius: 20px; box-shadow: 0 18px 50px rgba(31,53,97,.08) !important; overflow: hidden;">
        ...
        <div class="card-header text-white d-flex justify-content-between align-items-center" style="background: #006B3F; padding: 18px 24px; border-bottom: none;">
            <h5 class="mb-0" style="font-weight: 800; font-size: 16px;">Edit Data User</h5>
        ...
        <div class="card-body" style="padding: 28px;">
            ...
            <form action="{{ route('user.update', $user->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('name', $user->name) }}" required style="border-radius: 10px; padding: 10px 14px; font-size: 13px; border: 1px solid #e8edf5;">
                </div>

                <div class="mb-3">
                    <label class="form-label" style="font-size: 12.5px; font-weight: 800; color: #172033;">Email <span class="text-danger">*</span></label>
                    <input type="email" name="email" class="form-control" value="{{ old('email', $user->email) }}" required style="border-radius: 10px; padding: 10px 14px; font-size: 13px; border: 1px solid #e8edf5;">
                </div>

                <div class="mb-3">
                    <label class="form-label" style="font-size: 12.5px; font-weight: 800; color: #172033;">Nomor Telepon/HP</label>
                    <input type="text" name="phone" class="form-control" value="{{ old('phone', $user->phone) }}" style="border-radius: 10px; padding: 10px 14px; font-size: 13px; border: 1px solid #e8edf5;">
                </div>

                <div class="mb-3">
                    <label class="form-label" style="font-size: 12.5px; font-weight: 800; color: #172033;">Password Baru</label>
                    <input type="password" name="password" class="form-control" placeholder="Kosongkan jika tidak ingin mengubah password" style="border-radius: 10px; padding: 10px 14px; font-size: 13px; border: 1px solid #e8edf5;">
...
<select name="role" class="form-select" required style="border-radius: 10px; padding: 10px 14px; font-size: 13px; border: 1px solid #e8edf5;">
    ...
    <option value="tamu" {{ old('role', $user->role) == 'tamu' ? 'selected' : '' }}>Tamu</option>
                ...
                <div class="mb-4 form-check">
                    <input type="checkbox" name="is_active" class="form-check-input" id="is_active" value="1" {{ old('is_active', $user->is_active) ? 'checked' : '' }} style="cursor: pointer;">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn text-white" style="background: #006B3F; border: none; border-radius: 10px; padding: 10px 20px; font-weight: 800; font-size: 13px; box-shadow: 0 4px 15px rgba(0,107,63,.2);" onmouseover="this.style.background='#004d2e'" onmouseout="this.style.background='#006B3F'">Update User</button>
                </div>
            </form>
