...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
    ...
    <a href="{{ route('guest-categories.index') }}" style="background: #e5484d; color: #ffffff; padding: 10px 16px; border-radius: 12px; font-size: 13px; font-weight: 700; text-decoration: none; display: flex; align-items: center; gap: 6px; border: 1px solid #e8edf5; transition: all 0.2s;">
        &larr; Kembali
    </a>
</div>
    ...
    <form action="{{ route('guest-categories.store') }}" method="POST">
        ...
        <div style="margin-bottom: 28px;">
            ...
            <div style="display: flex; gap: 10px; align-items: center;">
                <input type="color" name="color" id="color" value="{{ old('color', '#006B3F') }}"
