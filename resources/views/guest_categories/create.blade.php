...
<div class="bg-white p-6 rounded-lg shadow-sm max-w-2xl mx-auto">
    ...
    <form action="{{ route('guest-categories.store') }}" method="POST">
        ...
        <div class="mb-4">
            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nama Guest Categories</label>
        ...
        <div class="mb-4">
            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Color Guest Categories</label>
