...
<body>
    ...
    <aside class="sidebar">
        ...
        <div style="padding: 20px; border-top: 1px solid #e8edf5;">
            <a href="#" style="display: flex; align-items: center; gap: 10px; color: #dc2626; text-decoration: none; font-size: 13px; font-weight: 700; padding: 10px; border-radius: 10px; background: #fef2f2;">
