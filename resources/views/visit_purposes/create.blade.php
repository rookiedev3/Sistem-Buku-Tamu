...
<div class="bg-white p-6 rounded-lg shadow-sm max-w-2xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-lg font-semibold text-gray-700">Tambah Visit Purposes</h2>
        <a href="{{ route('visit-purposes.index') }}" class="text-sm text-gray-500 hover:text-gray-700">
            &larr; Kembali
        </a>
    </div>
    ...
    <form action="{{ route('visit-purposes.store') }}" method="POST">
        ...
        <div class="mb-4">
            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nama Visit Purposes</label>
