...
<div style="display: flex; flex-direction: column; gap: 24px;">
    ...
    <div style="padding: 14px 24px; border-top: 1px solid #e8edf5; background: #fbfcfe; border-radius: 12px; display: flex; justify-content: space-between; align-items: center; color: #778195; font-size: 12px; flex-wrap: wrap; gap: 8px;">
